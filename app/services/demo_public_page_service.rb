class DemoPublicPageService < Services::Base
  def call
    ...
    PublicPageData.new(
      ...
      follower_daily_data_points_for_graph: follower_info[:data_points],
      follower_formatted_labels_for_graph: follower_info[:labels],

      followers_comparison_days: 90,
      followers_count: 43,
      followers_count_change_percentage_text: '0.5% increase',
      impression_daily_data_points_for_graph: impression_info[:data_points],
      impression_formatted_labels_for_graph: impression_info[:labels],
      impressions_change_since_last_week: '74.52% increase',
      impressions_comparison_days: 90,
      impressions_count: 5_817_920,
      likes_change_since_last_week: '9.72% increase',
      likes_comparison_days: 90,
      likes_count: 2913,
      maximum_days_of_data: 90,
      top_posts: generate_top_posts,
      days_of_data_in_recent_count: 90,
  ...
  def generate_follower_info
    follower_counts = Array.new(90) { rand(6000..8000) } # Example data
  ...
  def generate_impression_info
    impression_counts = Array.new(90) { rand(10_000..100_000) } # Example data
  ...
  def custom_tweets
    [
      ...
      },
      {
        ...
        like_count: 157,
        quote_count: 7,
        impression_count: 29_384,
        reply_count: 24,
        bookmark_count: 18
      },
      {
        id: 1_772_787_456_544_592_133,
        text: 'TIL Why does Cloudflare use lava lamps to help with encryption?',
        retweet_count: 104,
        like_count: 476,
        quote_count: 15,
        impression_count: 46_873,
        reply_count: 41,
        bookmark_count: 31
      },
      {
        id: 1_772_778_052_667_470_267,
