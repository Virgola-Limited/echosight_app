...
ActiveRecord::Schema[7.1].define(version: 20_240_529_205_101) do
  ...
  create_table 'mailkick_subscriptions', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[subscriber_type subscriber_id list], name: 'index_mailkick_subscriptions_on_subscriber_and_list',
                                                    unique: true
  end
