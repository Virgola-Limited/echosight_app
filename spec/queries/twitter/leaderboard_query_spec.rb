...
RSpec.describe Twitter::LeaderboardQuery, type: :query do
  describe '#snapshot' do
    ...
    let!(:tweet_metric1) { create(:tweet_metric, tweet: tweet1, impression_count: 100, retweet_count: 10, like_count: 20, quote_count: 5, reply_count: 2, bookmark_count: 3, created_at: 1.hour.ago) }
    let!(:tweet_metric2) { create(:tweet_metric, tweet: tweet2, impression_count: 200, retweet_count: 20, like_count: 30, quote_count: 10, reply_count: 5, bookmark_count: 7, created_at: 2.hours.ago) }
